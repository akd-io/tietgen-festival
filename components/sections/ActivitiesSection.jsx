  ...
  },
  {
    ...
    description: (
      <p>
        ...
        preferably with a theme and accompanying costumes. There is room for a
        total of 10 teams; first come, first served. The two best teams compete
        in a final round, where they have the opportunity to win a great prize
        and eternal honor.
      </p>
    ),
    ...
    description: (
      <>
        <p>
          ...
          cool residents of Tietgen will do a 5-7 minutes presentation inspired
          by a project they have worked on. They will each try to convince you
          that just their project is the most exciting.
        </p>
        <p>
        ...
        <p>
          ...
          exciting projects from residents and support your favorite candidate!
        </p>
      </>
    ),
    ...
    description: (
      <>
        <p>
          ...
          up in the circle, get a free bingo ticket and then you have the chance
          to win prizes with a total value of 10.000 kr. But of course there
          will be some obstacles to get the great prices. If you get bingo, the
          wheel of fortune will decide if you are going away with trash or
          treasure.
        </p>
        <p>
    ...
    description: (
      <>
        <p>
          ...
          Saturday afternoon we have invited Statskundskabsrevyen (The revue of
          political science). They will entertain with their best sketches from
          their recent revue. Join and get an insight into general and political
          student humor - there is guarantee for laughing.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        in the circle after the breakfast on Saturday. You will get a G&T which
        will be refilled as the Yoga teacher Ida will guide you through some
        great exercises. Yoga experience or just basic balance is not a
        requirement!
      </p>
    ),
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        💥💥 This year will be crazier than ever, when we in collaboration with
        RedBull turn the party hall into a FULL MOON party, with all the UV
        paint your heart desires!
      </p>
    ),
    ...
    description: (
      <>
        ...
        <p>
          Have you ever taken rows of soju shots and danced to loud korean pop
          music in an elevator? No? Well your time has come. Tietgen’s resident
          k-pop stan Signe Lilja is hosting, DJ-ing and bartendering in the
          first and only pop-up bar held in an in one of the building’s
          elevators. She will be serving Korea’s no. 1 spirit soju (소주) mixed
          with beer into the korean classic drink somaek (소맥) and korean
          snacks (No-one ever drank soju without eating ramen) all while the
          crispiest tunes of the best k-pop music of all time will be
          bang-bang-banging out the speakers.
        </p>
      </>
    ),
