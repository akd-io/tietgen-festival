      ...
      description: (
        <>
          ...
          <p>
            ...
            resident k-pop star Signe Lilja is hosting, DJ-ing and bartending in
            the first and only pop-up bar held in one of the building’s
            elevators.
          </p>
          <p>
            She will be serving Korea’s no. 1 spirit soju (소주) mixed with beer
            into the korean classic drink somaek (소맥) and korean snacks
            (No-one ever drank soju without eating ramen) all while the
